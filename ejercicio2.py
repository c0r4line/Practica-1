...
'''
contador= {} #dicc para contar ocurrencias de palabras

minuscula= texto.lower() #paso a minuscula 
puntuacion = re.sub(r'[^\w\s]','',minuscula) #saco puntuacion
palabras= puntuacion.split() #separo en palabras

for palabra in palabras:
    contador.setdefault(palabra, 0) #seteo en 0 todas las palabras
